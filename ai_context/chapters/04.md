...
encounter_rounds {
    ...
    number round_number
    datetime round_start_time
    datetime round_end_time
}
...
combat_actions {
    ...
    enum action_type
    string target_participant_id FK
...
encounters ||--o{ encounter_rounds : "breaks_into"
encounters ||--o{ encounter_participants : "includes"
encounters ||--o{ encounter_targets : "features"
encounter_participants ||--o{ combat_actions : "performs"
combat_actions ||--o{ attack_rolls : "results_in"
combat_actions ||--o{ defensive_actions : "triggers"
encounter_participants ||--o{ status_effects : "affected_by"
characters ||--o{ encounter_participants : "participates_as"
monsters ||--o{ encounter_targets : "designated_as"
...
enum EncounterType { COMBAT = "combat", MONSTER_HUNT = "monster_hunt", CONTRACT_SKIRMISH = "contract_skirmish", TRAINING = "training", SOCIAL_CONFLICT = "social_conflict" }

enum EncounterStatus { SCHEDULED = "scheduled", INITIATED = "initiated", IN_PROGRESS = "in_progress", PLAYER_VICTORY = "player_victory", PLAYER_DEFEAT = "player_defeat", FLED = "fled", RESOLVED = "resolved", LOGGED = "logged" }

enum EncounterOutcome { PLAYER_VICTORY = "player_victory", MONSTER_VICTORY = "monster_victory", MUTUAL_RETREAT = "mutual_retreat", MONSTER_FLED = "monster_fled", PLAYER_FLED = "player_fled", NEGOTIATED_RESOLUTION = "negotiated_resolution" }

enum EncounterParticipantRole { PLAYER_CHARACTER = "player_character", ENEMY_MONSTER = "enemy_monster", ALLY_NPC = "ally_npc", SUMMONED_ALLY = "summoned_ally", CONTRACT_SUPPORT = "contract_support", NEUTRAL = "neutral" }

enum EncounterTargetRole { PRIMARY_TARGET = "primary_target", SECONDARY_TARGET = "secondary_target", OBJECTIVE_MARKER = "objective_marker", ENVIRONMENTAL_HAZARD = "environmental_hazard" }
